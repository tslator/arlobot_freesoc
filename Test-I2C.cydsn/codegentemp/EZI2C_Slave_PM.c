...
{
    EZI2C_Slave_DISABLED,
    EZI2C_Slave_DEFAULT_XCFG,
    EZI2C_Slave_DEFAULT_ADDR,
    EZI2C_Slave_DEFAULT_CFG,
    EZI2C_Slave_DEFAULT_CLKDIV1,
    EZI2C_Slave_DEFAULT_CLKDIV2
};

#if (EZI2C_Slave_WAKEUP_ENABLED)
    volatile uint8 EZI2C_Slave_wakeupSource;
#endif /* (EZI2C_Slave_WAKEUP_ENABLED) */


/*******************************************************************************
* Function Name: EZI2C_Slave_SaveConfig
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  EZI2C_Slave_backup - The non-retention registers are saved to.
*
* Reentrant:
*  No.
*
...
void EZI2C_Slave_SaveConfig(void) 
{
    ...
    EZI2C_Slave_backup.cfg     = EZI2C_Slave_CFG_REG;
    EZI2C_Slave_backup.xcfg    = EZI2C_Slave_XCFG_REG;
    ...
    EZI2C_Slave_PWRSYS_CR1_REG |= EZI2C_Slave_PWRSYS_CR1_I2C_BACKUP;
    ...
    */
    EZI2C_Slave_XCFG_REG |= EZI2C_Slave_XCFG_FORCE_NACK;
    while (0u == (EZI2C_Slave_XCFG_REG & EZI2C_Slave_XCFG_SLEEP_READY))
    {
    }

     /* Setup wakeup interrupt */
    EZI2C_Slave_DisableInt();
    EZI2C_Slave_wakeupSource = 0u; /* Clear wakeup event */
    (void) CyIntSetVector(EZI2C_Slave_ISR_NUMBER, &EZI2C_Slave_WAKEUP_ISR);
...
/*******************************************************************************
* Function Name: EZI2C_Slave_RestoreConfig
********************************************************************************
*
* Summary:
*  The Enable wakeup from Sleep Mode selection influences this function
...
*
* Global variables:
*  EZI2C_Slave_backup - the non-retention registers are restored from.
*
* Reentrant:
*  No.
*
* Side Effects:
*  Calling this function before EZI2C_Slave_SaveConfig() or
*  EZI2C_Slave_Sleep() may produce unexpected behavior.
*
*******************************************************************************/
void EZI2C_Slave_RestoreConfig(void) 
{
    ...
    if (0u != (EZI2C_Slave_PWRSYS_CR1_I2C_BACKUP & EZI2C_Slave_PWRSYS_CR1_REG))
    /* Exit from Sleep */
    {
        /* Disable I2C backup regulator */
        intState = CyEnterCriticalSection();
        EZI2C_Slave_PWRSYS_CR1_REG &= (uint8) ~EZI2C_Slave_PWRSYS_CR1_I2C_BACKUP;
    ...
    else /* Exit from Hibernate (bit is cleared) or wakeup disabled */
    {
        ...
        EZI2C_Slave_backup.enableState = EZI2C_Slave_ENABLED;
    #endif /* (EZI2C_Slave_WAKEUP_ENABLED) */

        /* Restore component registers: Hibernate disable power */
        EZI2C_Slave_CFG_REG     = EZI2C_Slave_backup.cfg;
        EZI2C_Slave_XCFG_REG    = EZI2C_Slave_backup.xcfg;
    ...
    if (0u != EZI2C_Slave_wakeupSource)
    {
        /* Generate interrupt to release I2C bus */
        (void) CyIntSetPending(EZI2C_Slave_ISR_NUMBER);
    }
    EZI2C_Slave_EnableInt();
#endif /* (EZI2C_Slave_WAKEUP_ENABLED) */
}
...
*
* Global variables:
*  EZI2C_Slave_backup - The non retention registers are saved to. Changed
*  by EZI2C_Slave_SaveConfig() function call.
*
* Reentrant:
*  No.
*
...
{
#if (EZI2C_Slave_WAKEUP_ENABLED)
    /* Do not re-enable component in EZI2C_Slave_Wakeup(). It remains enabled as it is wakeup source */
    EZI2C_Slave_backup.enableState = EZI2C_Slave_DISABLED;
#else
    /* Store component state enabled or disable to restore after wakeup */
    EZI2C_Slave_backup.enableState = (EZI2C_Slave_PM_ACT_CFG_REG & EZI2C_Slave_ACT_PWR_EN);
...
* Side Effects:
*  Calling this function before EZI2C_Slave_SaveConfig() or
*  EZI2C_Slave_Sleep() will lead to unpredictable results.
*
*******************************************************************************/
void EZI2C_Slave_Wakeup(void) 
{
    EZI2C_Slave_RestoreConfig();
