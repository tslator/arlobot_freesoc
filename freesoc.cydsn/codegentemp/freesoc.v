...
module top ;
    ...
    UART_v2_50_9 UART_1 (
        ...
        .reset(1'b0),
        .rx(Net_9138),
        .tx_interrupt(Net_9161),
        .rx_interrupt(Net_9162),
        .tx_data(Net_9163),
        .tx_clk(Net_9164),
        .rx_data(Net_9165),
        .rx_clk(Net_9166));
