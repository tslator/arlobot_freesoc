...
void CAN_TxCancel(uint8 bufferId) 
{
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_SendMsgStatus
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    uint8 CAN_SendMsgStatus(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            else
            {
                ...
                #ifdef CAN_SEND_MSG_Status_CALLBACK
                    CAN_SendMsg_Status_Callback();
                #endif /* CAN_SEND_MSG_Status_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_SendMsgLeftRightSpeed
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    uint8 CAN_SendMsgLeftRightSpeed(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            {
                /* `#START MESSAGE_LeftRightSpeed_TRASMITTED` */

                /* `#END` */

                #ifdef CAN_SEND_MSG_LeftRightSpeed_CALLBACK
                    CAN_SendMsg_LeftRightSpeed_Callback();
                #endif /* CAN_SEND_MSG_LeftRightSpeed_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_SendMsgLeftRightDistance
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    uint8 CAN_SendMsgLeftRightDistance(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            {
                /* `#START MESSAGE_LeftRightDistance_TRASMITTED` */

                /* `#END` */

                #ifdef CAN_SEND_MSG_LeftRightDistance_CALLBACK
                    CAN_SendMsg_LeftRightDistance_Callback();
                #endif /* CAN_SEND_MSG_LeftRightDistance_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_SendMsgHeading
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    uint8 CAN_SendMsgHeading(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            {
                /* `#START MESSAGE_Heading_TRASMITTED` */

                /* `#END` */

                #ifdef CAN_SEND_MSG_Heading_CALLBACK
                    CAN_SendMsg_Heading_Callback();
                #endif /* CAN_SEND_MSG_Heading_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_SendMsgHeartbeat
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    uint8 CAN_SendMsgHeartbeat(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            {
                /* `#START MESSAGE_Heartbeat_TRASMITTED` */

                /* `#END` */

                #ifdef CAN_SEND_MSG_Heartbeat_CALLBACK
                    CAN_SendMsg_Heartbeat_Callback();
                #endif /* CAN_SEND_MSG_Heartbeat_CALLBACK */
...
void CAN_ReceiveMsg(uint8 rxMailbox) 
{
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_ReceiveMsgControl
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgControl(void) 
    {
        /* `#START MESSAGE_Control_RECEIVED` */

        /* `#END` */

        #ifdef CAN_RECEIVE_MSG_Control_CALLBACK
            CAN_ReceiveMsg_Control_Callback();
        #endif /* CAN_RECEIVE_MSG_Control_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:    CAN_ReceiveMsgCommand
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_ReceiveMsgCommand(void) 
    {
        /* `#START MESSAGE_Command_RECEIVED` */

        /* `#END` */

        #ifdef CAN_RECEIVE_MSG_Command_CALLBACK
            CAN_ReceiveMsg_Command_Callback();
        #endif /* CAN_RECEIVE_MSG_Command_CALLBACK */
