...
uint8 Front_CliffDetect_initVar = 0u;

/* Internal functions definitoin */
static void Front_CliffDetect_trimAdjust(uint8 nibble) ;

/* static Front_CliffDetect_backupStruct  Front_CliffDetect_backup; */
#if (CY_PSOC5A)
    static Front_CliffDetect_LOWPOWER_BACKUP_STRUCT  Front_CliffDetect_lowPowerBackup;
#endif /* CY_PSOC5A */

/* variable to decide whether or not to restore the control register in 
   Enable() API for PSoC5A only */
#if (CY_PSOC5A)
    static uint8 Front_CliffDetect_restoreReg = 0u;
#endif /* CY_PSOC5A */


/*******************************************************************************
* Function Name: Front_CliffDetect_Init
********************************************************************************
*
* Summary:
...
void Front_CliffDetect_Init(void) 
{
    ...
    Front_CliffDetect_SetSpeed(Front_CliffDetect_DEFAULT_SPEED);

    /* Set default Hysteresis */
    #if ( Front_CliffDetect_DEFAULT_HYSTERESIS == 0u )
        Front_CliffDetect_CR |= Front_CliffDetect_HYST_OFF;
    #else
        Front_CliffDetect_CR &= (uint8)(~Front_CliffDetect_HYST_OFF);
    #endif /* Front_CliffDetect_DEFAULT_HYSTERESIS == 0u */
    /* Power down override feature is not supported for PSoC5A. */
    #if (CY_PSOC3 || CY_PSOC5LP)
        /* Set default Power Down Override */
        #if ( Front_CliffDetect_DEFAULT_PWRDWN_OVRD == 0u )
            Front_CliffDetect_CR &= (uint8)(~Front_CliffDetect_PWRDWN_OVRD);
        #else 
            Front_CliffDetect_CR |= Front_CliffDetect_PWRDWN_OVRD;
        #endif /* Front_CliffDetect_DEFAULT_PWRDWN_OVRD == 0u */
    #endif /* CY_PSOC3 || CY_PSOC5LP */
    
    /* Set mux always on logic */
    Front_CliffDetect_CR |= Front_CliffDetect_MX_AO;

    /* Set default sync */
    Front_CliffDetect_CLK &= (uint8)(~Front_CliffDetect_SYNCCLK_MASK);
    #if ( Front_CliffDetect_DEFAULT_BYPASS_SYNC == 0u )
        Front_CliffDetect_CLK |= Front_CliffDetect_SYNC_CLK_EN;
    #else
        Front_CliffDetect_CLK |= Front_CliffDetect_BYPASS_SYNC;
    #endif /* Front_CliffDetect_DEFAULT_BYPASS_SYNC == 0u */
}


/*******************************************************************************
* Function Name: Front_CliffDetect_Enable
********************************************************************************
*
* Summary:
...
{
    Front_CliffDetect_PWRMGR |= Front_CliffDetect_ACT_PWR_EN;
    Front_CliffDetect_STBY_PWRMGR |= Front_CliffDetect_STBY_PWR_EN;
     
     /* This is to restore the value of register CR which is saved 
    in prior to the modification in stop() API */
    #if (CY_PSOC5A)
        if(Front_CliffDetect_restoreReg == 1u)
        {
            Front_CliffDetect_CR = Front_CliffDetect_lowPowerBackup.compCRReg;

            /* Clear the flag */
            Front_CliffDetect_restoreReg = 0u;
        }
    #endif /* CY_PSOC5A */
}
...
/*******************************************************************************
* Function Name: Front_CliffDetect_Start
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  Front_CliffDetect_initVar: Is modified when this function is called for the 
...
void Front_CliffDetect_Start(void) 
{
    ...
    if ( Front_CliffDetect_initVar == 0u )
    {
        Front_CliffDetect_Init();
        
        Front_CliffDetect_initVar = 1u;
    }   
...
/*******************************************************************************
* Function Name: Front_CliffDetect_Stop
********************************************************************************
*
* Summary:
...
void Front_CliffDetect_Stop(void) 
{
    ...
    Front_CliffDetect_PWRMGR &= (uint8)(~Front_CliffDetect_ACT_PWR_EN);
    Front_CliffDetect_STBY_PWRMGR &= (uint8)(~Front_CliffDetect_STBY_PWR_EN);
    
    #if (CY_PSOC5A)
        /* Enable the variable */
        Front_CliffDetect_restoreReg = 1u;

        /* Save the control register before clearing it */
        Front_CliffDetect_lowPowerBackup.compCRReg = Front_CliffDetect_CR;
        Front_CliffDetect_CR = Front_CliffDetect_COMP_REG_CLR;
    #endif /* CY_PSOC5A */
}


/*******************************************************************************
* Function Name: Front_CliffDetect_SetSpeed
********************************************************************************
*
* Summary:
...
void Front_CliffDetect_SetSpeed(uint8 speed) 
{
    ...
    Front_CliffDetect_CR = (Front_CliffDetect_CR & (uint8)(~Front_CliffDetect_PWR_MODE_MASK)) |
                           (speed & Front_CliffDetect_PWR_MODE_MASK);

    /* Set trim value for high speed comparator */
    if(speed == Front_CliffDetect_HIGHSPEED)
    {
        /* PSoC5A */
        #if (CY_PSOC5A)
            Front_CliffDetect_TR = Front_CliffDetect_HS_TRIM_TR0;
        #endif /* CY_PSOC5A */
        
        /* PSoC3, PSoC5LP or later */
        #if (CY_PSOC3 || CY_PSOC5LP) 
            Front_CliffDetect_TR0 = Front_CliffDetect_HS_TRIM_TR0;
            Front_CliffDetect_TR1 = Front_CliffDetect_HS_TRIM_TR1;
        #endif /* CY_PSOC3 || CY_PSOC5LP */
    }
    else
    {
    /* PSoC5A */
        #if (CY_PSOC5A)
            Front_CliffDetect_TR = Front_CliffDetect_LS_TRIM_TR0;
        #endif /* CY_PSOC5A */
        
        /* PSoC3, PSoC5LP or later */
        #if (CY_PSOC3 || CY_PSOC5LP) 
            Front_CliffDetect_TR0 = Front_CliffDetect_LS_TRIM_TR0;
            Front_CliffDetect_TR1 = Front_CliffDetect_LS_TRIM_TR1;
        #endif /* CY_PSOC3 || CY_PSOC5LP */
    }
...
/*******************************************************************************
* Function Name: Front_CliffDetect_GetCompare
********************************************************************************
*
* Summary:
...
{
    return( Front_CliffDetect_WRK & Front_CliffDetect_CMP_OUT_MASK);
}


/*******************************************************************************
* Function Name: Front_CliffDetect_trimAdjust
********************************************************************************
*
* Summary:
...
static void Front_CliffDetect_trimAdjust(uint8 nibble) 
{
    ...
    cmpState = Front_CliffDetect_WRK & Front_CliffDetect_CMP_OUT_MASK;
    ...
    {    
        ...
        if ( cmpState != 0u )
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                Front_CliffDetect_TR |= Front_CliffDetect_CMP_TRIM1_DIR;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                Front_CliffDetect_TR0 |= Front_CliffDetect_CMP_TR0_DIR;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
    }
    else
    {
        ...
        if ( cmpState == 0u )
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                Front_CliffDetect_TR |= Front_CliffDetect_CMP_TRIM2_DIR; 
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                Front_CliffDetect_TR1 |= Front_CliffDetect_CMP_TR1_DIR;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
    }
    ...
    for ( trimCnt = 0u; trimCnt < trimCntMax; trimCnt++ )
	{
        if (nibble == 0u)
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                Front_CliffDetect_TR += 1u;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                Front_CliffDetect_TR0 += 1u;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
        else
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                Front_CliffDetect_TR += 0x10u;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                Front_CliffDetect_TR1 += 1u;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
        ...
        if ((Front_CliffDetect_WRK & Front_CliffDetect_CMP_OUT_MASK) != cmpState)
        {
...
/*******************************************************************************
* Function Name: Front_CliffDetect_ZeroCal
********************************************************************************
*
* Summary:
...
uint16 Front_CliffDetect_ZeroCal(void) 
{
    ...
    tmpSW0 = Front_CliffDetect_SW0;
    tmpSW2 = Front_CliffDetect_SW2;
    tmpSW3 = Front_CliffDetect_SW3;

     /* Clear routing for inP, retain routing for inN */
    Front_CliffDetect_SW0 = 0x00u;
    Front_CliffDetect_SW2 = 0x00u;
    Front_CliffDetect_SW3 = tmpSW3 & (uint8)(~Front_CliffDetect_CMP_SW3_INPCTL_MASK);

    /* Preserve original configuration
     * - turn off Hysteresis
     * - set calibration bit - shorts inN to inP
    */
    tmpCR = Front_CliffDetect_CR;
    Front_CliffDetect_CR |= (Front_CliffDetect_CAL_ON | Front_CliffDetect_HYST_OFF);
    
    /* Write default low values to trim register - no offset adjust */
    /* PSoC5A */
    #if (CY_PSOC5A)
        Front_CliffDetect_TR = Front_CliffDetect_DEFAULT_CMP_TRIM;
    #endif /* CY_PSOC5A */
    
    /* PSoC3, PSoC5LP or later */
    #if (CY_PSOC3 || CY_PSOC5LP)
        Front_CliffDetect_TR0 = Front_CliffDetect_DEFAULT_CMP_TRIM;
        Front_CliffDetect_TR1 = Front_CliffDetect_DEFAULT_CMP_TRIM;
    #endif /* CY_PSOC3 || CY_PSOC5LP */
	
	/* Two phase trim - slow modes, one phase trim - for fast */ 
    if ( (Front_CliffDetect_CR & Front_CliffDetect_PWR_MODE_MASK) == Front_CliffDetect_PWR_MODE_FAST)
    {
        Front_CliffDetect_trimAdjust(0u);
    }
    else /* default to trim for fast modes */
    {
        Front_CliffDetect_trimAdjust(1u);
		Front_CliffDetect_trimAdjust(0u);
    }
   
    /* Restore Config Register */
    Front_CliffDetect_CR = tmpCR;
    
    /* Restore routing registers for inP */
    Front_CliffDetect_SW0 = tmpSW0;
    Front_CliffDetect_SW2 = tmpSW2;
    Front_CliffDetect_SW3 = tmpSW3;
    
    /* PSoC5A */
    #if (CY_PSOC5A)
        return (uint16) Front_CliffDetect_TR;
    #endif /* CY_PSOC5A */
    
    /* PSoC3, PSoC5LP or later */
    #if (CY_PSOC3 || CY_PSOC5LP)
        return ((uint16)((uint16)Front_CliffDetect_TR1 << 8u) | (Front_CliffDetect_TR0));        
    #endif /* CY_PSOC3 || CY_PSOC5LP */
}


/*******************************************************************************
* Function Name: Front_CliffDetect_LoadTrim
********************************************************************************
*
* Summary:
...
void Front_CliffDetect_LoadTrim(uint16 trimVal) 
{
    ...
    /*******************************************************************************
    * Function Name: Front_CliffDetect_PwrDwnOverrideEnable
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: Front_CliffDetect_PwrDwnOverrideDisable
    ********************************************************************************
    *
    * Summary:
