...
#define MAX_WHEEL_CCW_ANGULAR_VELOCITY     (-MAX_WHEEL_RADIAN_PER_SECOND)   // radian/sec
...
#define MAX_WHEEL_CCW_COUNT_PER_SEC (MAX_WHEEL_CCW_ANGULAR_VELOCITY / WHEEL_RADIAN_PER_COUNT)
